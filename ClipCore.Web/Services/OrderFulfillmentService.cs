...
public class OrderFulfillmentService
{
    ...
    private readonly ClipCore.Web.Services.CartService _cartService;
    private readonly IPromoCodeRepository _promoCodeRepository;
    private readonly IAuditService _auditService;
    private readonly IEmailService _emailService;
    private readonly EmailTemplateService _emailTemplateService;
    private readonly AuthenticationStateProvider _authenticationStateProvider;
    private readonly ClipCore.Web.Services.StoreSettingsService _storeSettingsService;
    ...
    public OrderFulfillmentService(
        ...
        ClipCore.Web.Services.CartService cartService,
        IPromoCodeRepository promoCodeRepository,
        IAuditService auditService,
        IEmailService emailService,
        EmailTemplateService emailTemplateService,
        AuthenticationStateProvider authenticationStateProvider,
        ClipCore.Web.Services.StoreSettingsService storeSettingsService,
    ...
    public async Task<List<Purchase>> FulfillOrderAsync(string sessionId)
    {
        ...
        try
        {
            ...
            var subject = $"{storeName ?? "ClipCore"} Order Receipt (#{shortOrderId})";
            ...
            if (purchases.All(p => p.FulfillmentStatus == FulfillmentStatus.Fulfilled))
            {
                ...
                var fulfillSubject = $"{storeName ?? "ClipCore"} - Your Order is Ready! (#{shortOrderId})";
