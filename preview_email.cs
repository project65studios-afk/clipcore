...
{
    new Purchase { ClipTitle = "Gravel Tower Coin — Limited Edition", CollectionName = "Azusa Canyon", PricePaidCents = 3499, ClipThumbnailFileName = "sample1.jpg", CreatedAt = DateTime.UtcNow },
    new Purchase { ClipTitle = "King of the Mountain — Collector's Edition", CollectionName = "Mulholland Hwy", PricePaidCents = 5499, ClipThumbnailFileName = "sample2.jpg", CreatedAt = DateTime.UtcNow }
};
